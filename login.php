    ...
    <div class="container-custom">
        <div class="card-profissional">
            ...
            <div class="card-header-profissional">
                ...
                <p class="mb-0 opacity-90 fw-medium">Bem-vindo de volta</p>
            </div>
            ...
            <div class="card-body-profissional">
                <!-- Mensagens de Erro -->
                <?php if (isset($erro)): ?>
                <div class="alert alert-danger alert-profissional alert-dismissible fade show mb-4" role="alert">
                ...
                <form method="POST" id="loginForm">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary-profissional">
                            <i class="fas fa-sign-in-alt me-2"></i> Acessar Minha Conta
                        </button>
                    </div>
                </form>
                ...
                <div class="forgot-password">
                    <a href="recuperar-senha.php" class="link-profissional">
                ...
                <div class="register-link">
                    <p class="text-muted mb-1">
                        Não faz parte do ATLAS?
                    </p>
                    <a href="cadastro.php" class="link-profissional">
                        <i class="fas fa-user-plus me-2"></i> Crie sua conta agora
                    </a>
                </div>
            </div>
        </div>
